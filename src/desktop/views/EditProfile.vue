<template>
    <div style="display: flex; justify-content: center;">
        <n-card size="small" role="dialog" aria-modal="true" style="width: 25vw;">
                ...
                <n-form style="flex-grow: 1;">
                    <div style="display: flex; flex-direction: row; ">
                        ...
                        <n-button text @click="showEditAvatar = true">
                            <img class="editing-avatar" :src="showingAvatar" alt="avatar"
...
import OperatorPicker from '@/desktop/components/OperatorPicker.vue'
